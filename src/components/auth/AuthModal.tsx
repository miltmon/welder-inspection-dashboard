...
import { X, User, Mail, Lock, Building, Award } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        const displayName = `${formData.displayName} (${formData.company})`;
      ...
      <div className="bg-slate-800 rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-slate-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none ${
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-all duration-200"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 bg-white hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed text-gray-900 font-medium rounded-lg transition-colors flex items-center justify-center space-x-2"
          >
        ...
        {mode === 'signup' && (
          <div className="mt-6 p-4 bg-blue-900/30 border border-blue-700 rounded-lg">
            <h3 className="text-sm font-medium text-blue-300 mb-2">What You Get</h3>
            <ul className="text-xs text-blue-200 space-y-1">
              <li>• Cloud sync across all your devices</li>
              <li>• Real-time collaboration with your team</li>
              <li>• Automatic data backup and security</li>
